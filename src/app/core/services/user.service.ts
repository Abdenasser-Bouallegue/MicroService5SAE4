...
export class UserService  {
  ...
  acceptQuest(idQuest: number): Observable<void> {
    return this.http.post<void>(`${this.apiUrl}/acceptQuest/${idQuest}`, null);
  }

  rejecterQuest(id: number): Observable<void> {
    return this.http.post<void>(`${this.apiUrl}/rejecterQuest/${id}`,null);
  }
